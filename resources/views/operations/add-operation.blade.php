                        ...
                        <div class="card-body">
                            <div class="step-indicator mb-4">
                                ...
                                <div class="step" data-step="3">
                                    ...
                                    <div class="step-label">Notes & Submit</div>
                                </div>
                            </div>
                            ...
                            <form id="operationForm" action="{{ route('operations/store') }}" method="POST">
                                ...
                                <div class="step-content active" data-step="1">
                                    <div class="form-section">
                                        ...
                                        <p class="text-muted mb-4">Select your current rotation and the objective for this
                                            operation</p>
                                                    ...
                                                    <select name="rotation_id"
                                                        ...
                                                        @foreach ($rotations as $rotation)
                                                            <option value="{{ $rotation->id }}"
                                                                {{ old('rotation_id') == $rotation->id ? 'selected' : '' }}>
                                ...
                                <div class="step-content" data-step="2">
                                    <div class="form-section">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="procedure_date"
                                                        ...
                                                        value="{{ old('procedure_date', date('Y-m-d')) }}" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="procedure_time"
                                                        ...
                                                        value="{{ old('procedure_time') }}" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="duration"
                                                        ...
                                                        min="1" placeholder="60" value="{{ old('duration') }}"
                                                        required>
                                                    @error('duration')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Participation Type <span
                                                            class="text-danger">*</span></label>
                                                    <select name="participation_type"
                                                        ...
                                                        <option value="Assist"
                                                            {{ old('participation_type') == 'Assist' ? 'selected' : '' }}>
                                                            Assist</option>
                                                        <option value="Perform"
                                                            {{ old('participation_type') == 'Perform' ? 'selected' : '' }}>
                                                            Perform</option>
                                                        <option value="Observe"
                                                            {{ old('participation_type') == 'Observe' ? 'selected' : '' }}>
                                                            Observe</option>
                                                        <option value="Perform with Assist"
                                                            {{ old('participation_type') == 'Perform with Assist' ? 'selected' : '' }}>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="card border-left-primary">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p><strong>Rotation:</strong> <span id="summary-rotation"
                                                                class="text-muted">Not selected</span></p>
                                                        <p><strong>Objective:</strong> <span id="summary-objective"
                                                                class="text-muted">Not selected</span></p>
                                                        <p><strong>Date:</strong> <span id="summary-date"
                                                                class="text-muted">Not set</span></p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p><strong>Time:</strong> <span id="summary-time"
                                                                class="text-muted">Not set</span></p>
                                                        <p><strong>Duration:</strong> <span id="summary-duration"
                                                                class="text-muted">Not set</span></p>
                                                        <p><strong>Participation:</strong> <span id="summary-participation"
                                                                class="text-muted">Not selected</span></p>
                                                        <p><strong>Supervisor:</strong> <span id="summary-supervisor"
                                                                class="text-muted">Not selected</span></p>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success" id="submitBtn"
                                        style="display: none;">
                                        <i class="fas fa-save me-2"></i>Submit Operation
                                    </button>
                                </div>
                            </form>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        // Trigger on page load (for edit/old form data)
        ...
        function updateSummary() {
            ...
            document.getElementById('summary-supervisor').textContent =
                supervisorSelect.selectedOptions[0]?.text || 'Not selected';
        }
        ...
        $(document).ready(function() {
            ...
            // REMOVED the validation call that was showing errors on every change
