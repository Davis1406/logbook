            ...
            <div class="row">
                @if (Session::get('role_name') !== 'Trainee')
                    <div class="col-md-6">
                        ...
                        @if ($operation->trainee)
                            {{ $operation->trainee->first_name . ' ' . $operation->trainee->last_name }}
                        @else
                            N/A
                        @endif
                    </div>
                ...
                <div class="col-md-6"><strong>Objective:</strong> {{ $operation->objective->objective_code }} -
                    {{ $operation->objective->description }}</div>
                ...
                <div class="col-12 mt-2"><strong>Status:</strong>
                    <span
                        class="badge bg-{{ $operation->status == 'approved' ? 'success' : ($operation->status == 'rejected' ? 'danger' : 'warning') }}">
